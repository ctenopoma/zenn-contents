---
title: "最適化の解を「見る」道具立て 〜 表・ガント・ネットワークの3つの型"
emoji: "📊"
...
数理最適化を大学1年レベルから列生成法・分枝価格法まで学ぶ教材の第3回です。目次はこちら。
...
これを眺めて「よし、正しい」と言える人はいません。実務の最適化では、可視化は飾りではなく**必須工程**です。理由は2つ。
...
準備編はここまで。次回から第1部・線形計画(LP)編です。2製品の生産計画を**方眼紙の上で**解き、「実行可能領域」「等高線」「最適解はなぜ角に来るのか」を絵で理解します。大学1年の数学だけで最適化の心臓部に触れる回です。
